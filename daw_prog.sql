...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-05-2025 a las 12:34:19
...
CREATE TABLE `materias` (
  ...
  `id_especialidad` int(2) DEFAULT NULL,
  `id_optativa` int(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;
...
ALTER TABLE `materias`
  ...
  ADD CONSTRAINT `fk_id_departamento` FOREIGN KEY (`id_departamento`) REFERENCES `departamentos` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_id_especialidad` FOREIGN KEY (`id_especialidad`) REFERENCES `especialidades` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_id_optativa` FOREIGN KEY (`id_optativa`) REFERENCES `optativas` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_id_tipo` FOREIGN KEY (`id_tipo`) REFERENCES `tipo_asignatura` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
